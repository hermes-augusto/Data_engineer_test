...
def gera_csv_envia(qlinhas, cvsname):
    ...
    try:
        ...
        raise
valores, chaves = gera_csv_envia(int(qtd_sh),'/home/hermes/teste/files/massa_teste.csv')
...
def gera_csv_rec(qlinhas, cvsname, valores, chaves):
    ...
    try:
        ...
        raise
gera_csv_rec(int(qtd_sh)*2,'/home/hermes/teste/files/massa_rec.csv',valores,chaves)
